...
class NhsScope {
  ...
  static const NhsScope gpIntegrationCredentials = NhsScope._('gp_integration_credentials');

  /// This scope value requests access to the End-User’s
  /// [NhsUserinfo.gpRegistrationDetails] claims as held within the NHS Personal
  /// Demographics Service
  static const NhsScope gpRegistrationDetails = NhsScope._('gp_registration_details');
...
class NhsScopeSerializer implements PrimitiveSerializer<NhsScope> {
  ...
  @override
  Object serialize(Serializers serializers, NhsScope error, {FullType specifiedType = FullType.unspecified}) {
    return error._value;
  }

  @override
  NhsScope deserialize(Serializers serializers, Object serialized, {FullType specifiedType = FullType.unspecified}) {
